...
class OppEx3 extends StatefulWidget {
  final String structName;
  const OppEx3({super.key, required this.structName});

  @override
  State<OppEx3> createState() => _OppEx3State();
}

class _OppEx3State extends State<OppEx3> {
  bool showForm = false; // Contrôle la visibilité du formulaire
