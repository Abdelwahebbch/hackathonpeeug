...
class OppEx1 extends StatefulWidget {
  final String structName;
  const OppEx1({super.key, required this.structName});

  @override
  State<OppEx1> createState() => _OppEx1State();
}

class _OppEx1State extends State<OppEx1> {
